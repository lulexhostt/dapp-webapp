...
export default function EosiSection8() {
  return (
    <div className=" bg-[#F5F7FF] flex flex-row sm:space-x-6  justify-start items-center mx-4 max-w-7xl  sm:mx-auto  ">


        <div className=" flex flex-col  w-full">

            <p className="font-semibold text-3xl pb-8">We value our <span className="text-green-800 ">Pro-Traders</span> </p>
