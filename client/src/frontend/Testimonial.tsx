...
export default function Testimonial() {
  return (
    <div className="bg-[#F5F7FF] flex flex-row my-32 space-x-20  justify-between items-center mx-4 max-w-7xl  sm:mx-auto   ">
        <div className="w-6/12  rounded-lg border  shadow-lg p-12 shadow-slate-400 h-96 bg-white hover:translate-x-2 duration-700">
